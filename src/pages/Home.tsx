...
export default function Home() {
  return (
    <PrimaryLayout>
      <section className="ff-grid ff-grid-cols-1 ff-p-6 ff-py-6 md:ff-grid-flow-col md:ff-grid-cols-2 md:ff-px-[25%] md:ff-pb-32">
      ...
      <section className="ff-relative ff-bg-alt-background ff-px-6 ff-py-10 md:ff-px-[25%]">
        ...
        <div className="ff-flex-gap-y-5 ff-flex ff-flex-col md:ff-flex-row md:ff-items-center md:ff-gap-x-14">
          ...
          <div className="ff-flex ff-flex-col ff-gap-y-5 md:ff-order-1">
            ...
            <p className="ff-text-xl md:ff-max-w-[41.75rem] md:ff-text-2xl md:ff-leading-[2.25rem]">
              We're dedicated to supporting the Conflux ecosystem with a rigorous selection process that ensures we community with only the
              most promising and impactful projects.
            </p>
          </div>
        </div>
        <InvitationForm
