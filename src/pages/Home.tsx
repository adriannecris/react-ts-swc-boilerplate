...
export default function Home() {
  return (
    <PrimaryLayout>
      <section className="ff-grid ff-grid-cols-1 ff-p-6 ff-py-6 md:ff-grid-flow-col md:ff-grid-cols-2 md:ff-px-[10%] md:ff-pb-32">
        <div className="md:ff-order-1 md:ff-flex md:ff-items-end md:ff-justify-end">
        ...
        <img
          src="/home/rocket.svg"
          className="ff-aspect-square ff-w-full ff-max-w-[31.875rem] md:ff-order-3 md:ff-col-span-2 md:ff-row-span-2"
        />
        <div className="ff-flex ff-flex-col ff-gap-y-3 md:ff-order-2 md:ff-w-full md:ff-max-w-[35.875rem] md:ff-self-center md:ff-justify-self-end">
      ...
      <section className="ff-relative ff-bg-alt-background ff-px-6 ff-py-10 md:ff-px-[10%]">
        ...
        <div className="ff-flex-gap-y-5 ff-mb-20 ff-flex ff-flex-col md:ff-flex-row md:ff-items-center md:ff-gap-x-14">
          <img
            ...
            className="ff-h-auto ff-max-h-[28.125rem] ff-w-full ff-max-w-[28.125rem]"
          />
        ...
        <div className="ff-flex-gap-y-5 ff-flex ff-flex-col md:ff-flex-row md:ff-items-center md:ff-gap-x-14">
          <img
            ...
            className="ff-h-auto ff-max-h-[28.125rem] ff-w-full ff-max-w-[28.125rem] md:ff-order-2"
          />
